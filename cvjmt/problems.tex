...
Bessie the Cow found a website called \href{vixra.org}{vixra.org} which mostly publishes high quality scientific bullpoop.
There's a \href{https://vixra.org/abs/2008.0229}{paper} which presents a simple method that supposedly checks whether integers greater than $5$ are prime.
...
\begin{displayquote}
    ...
    \begin{itemize}
        ...
        \item[c)] The sum of the digits of each of the remaining numbers is not divisiblie by $3$.
    \end{itemize}
...
\begin{wrapfigure}{r}{0.35\linewidth}
	...
	\begin{tikzpicture}[scale=0.5]
		...
		\tkzDefPointBy[rotation=center A angle -50](B)
		\tkzGetPoint{D}
		\tkzFillSector[rotate,fill=gray!20](A,D)(100)
		\tkzDrawCircle(A,B)
		...
		\tkzGetPoint{E}
		\tkzDrawSegment(A,E)
		\tkzLabelSegment[right](A,E){$21$ cm}
		\tkzDefPointBy[rotation=center A angle 145](B)
		\tkzGetPoint{F}
		\tkzDrawSegment(A,F)
		\tkzLabelSegment[below right](A,F){$42$ cm}
	\end{tikzpicture}
	\vspace{-20pt}
\end{wrapfigure}
Farmer John made a mooshroom pizza for the cows.
(Mooshroom pizzas are ethically sourced and don't contain mooshroom minecraft meat.
...
If the radius of the pizza is $42$ cm and the cut is $21$ cm away from the center of the pizza, what is the area of the smaller piece of pizza that was cut off?
Express your answer in exact form.
\end{document}
