    ...
    \begin{enumerate}
        \item A bar graph shows the number of hamburgers sold by a fast food chain each season.
            ...
            \begin{solution}
                ...
                \end{align*}
            \end{solution}
        \item Supposed one of the eight lettered identical squares included with the four squares in the T-shaped figure outlined.
            ...
            \begin{solution}
                ...
                Then the there are six edges "open" (for lack of better term).
